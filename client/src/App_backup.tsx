  ...
  const playSound = (soundType: string) => {
    try {
      ...
      switch (soundType) {
        ...
        case 'completion_bell': audioFile = '/attached_assets/completion-bell.wav'; break;
        case 'easter_melody': audioFile = '/attached_assets/easter-melody.wav'; break;
        case 'cash_register_ding': audioFile = '/attached_assets/cash-register-ding.wav'; break;
        case 'envelope_place': audioFile = '/attached_assets/envelope-place.wav'; break;
        case 'envelope_seal': audioFile = '/attached_assets/envelope-seal.wav'; break;
        case 'bill_snap': audioFile = '/attached_assets/bill-snap.wav'; break;
        case 'bill_count': audioFile = '/attached_assets/bill-count.wav'; break;
        case 'bill_rustle': audioFile = '/attached_assets/bill-rustle.wav'; break;
        case 'cash_drawer_close': audioFile = '/attached_assets/cash-drawer-close.wav'; break;
        case 'drawer_close': audioFile = '/attached_assets/drawer-close.wav'; break;
        default: return;
      }
